...
namespace DecentDubs.UserService.Migrations
{
    ...
    [Migration("20240928160324_UpdatedForeignKeyConfig")]
    partial class UpdatedForeignKeyConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DecentDubs.UserService.Models.SocialMediaLink", b =>
                {
                    b.HasOne("DecentDubs.UserService.Models.SocialMediaType", null)
                        .WithMany()
                        .HasForeignKey("SocialMediaTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DecentDubs.UserService.Models.User", null)
                        .WithMany()
